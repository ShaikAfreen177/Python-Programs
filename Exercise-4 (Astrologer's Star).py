"""
In Exercise-4, we had to create a program that could print some patterns of stars.

1.You have to take an integer type variable, and the input of the variable will define the length of the triangle.
